...
<body>
    ...
    <div id="main">
        ...
        <div class="tile">
            <div>
                <p style="text-align: center">Delete Manuscript</p>
            </div>
            <div style="text-align: center">
                <form action="delete_manuscript.php" method="post" style="padding-top: 10px;">
                <input type="text" name="pub_id" id="" placeholder="Enter Publisher ID" >
        ...
        <div class="tile">
            <div>
                <p style="text-align: center">Modify Manuscript</p>
            </div>
            <div style="text-align: center">
                <form action="modify_manuscript.php" method="post" style="padding-top: 10px;">
                <input type="text" name="pub_id" id="" placeholder="Enter Publishers ID" >
                <input type="text" name="author_id" id="" placeholder="Enter Your ID" >
