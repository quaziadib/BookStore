...
<body>
    ...
    <div class="tile">
            ...
            <div style="text-align: center">
                <form action="delete_admin.php" method="post" style="padding-top: 10px;">
                <input type="text" name="admin_id" id="" placeholder="Enter Book ID" >
                <br>
        ...
        <div class="tile">
            ...
            <div style="text-align: center">
                <form action="add_admin.php" method="post" style="padding-top: 10px;">
